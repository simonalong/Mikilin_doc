...
#### @FieldBlackMatcher <a id="@FieldBlackMatcher"></a>
 ...
 **自定义占位符有两个： \| 占位符 \| 详解 \| \| ------ \| ------ \| \| \#root \| 表示属性所在类的对象值 \| \| \#current \| 表示当前属性的值 \| 添加自定义占位符主要是用于在对象的属性间有相互约束的时候用，比如，属性a和属性b之和大于属性c，这种就可以使用自定义占位符使用。**
